...
public class CustomViewBehind extends ViewGroup {
	...
	//Winson Li --- 2013.09.28
	private boolean mQuickReturnEnable = false;
	...
	public boolean menuOpenTouchAllowed(View content, int currPage, float x) {
		...
		case SlidingMenu.TOUCHMODE_MARGIN:
			//Winson Li
			return menuTouchInQuickReturn2(content, currPage, x);
		}
		return false;
	}
	
	//Winson Li
	public boolean menuTouchInQuickReturn2(View content, int currPage, float x) {
